...
import { createVNode, Text, getCurrentInstance, ref, shallowRef, computed, watch, Fragment, defineComponent, h, effectScope, inject, onMounted, onUnmounted, onBeforeMount, isRef } from "./vendor-vue-Dj1-cm8e.js";
...
const generateFormatCacheKey = /* @__PURE__ */ __name((locale, key, source) => friendlyJSONstringify({ l: locale, k: key, s: source }), "generateFormatCacheKey");
...
const create = /* @__PURE__ */ __name((obj = null) => _create(obj), "create");
let _globalThis;
...
function createScanner(str) {
  ...
  let _column = 1;
  let _peekOffset = 0;
  const isCRLF = /* @__PURE__ */ __name((index2) => _buf[index2] === CHAR_CR && _buf[index2 + 1] === CHAR_LF, "isCRLF");
  const isLF = /* @__PURE__ */ __name((index2) => _buf[index2] === CHAR_LF, "isLF");
  const isPS = /* @__PURE__ */ __name((index2) => _buf[index2] === CHAR_PS, "isPS");
  const isLS = /* @__PURE__ */ __name((index2) => _buf[index2] === CHAR_LS, "isLS");
  const isLineEnd = /* @__PURE__ */ __name((index2) => isCRLF(index2) || isLF(index2) || isPS(index2) || isLS(index2), "isLineEnd");
  const index = /* @__PURE__ */ __name(() => _index, "index");
...
function createTokenizer(source, options = {}) {
  ...
  function isTextStart(scnr, reset = true) {
    const fn = /* @__PURE__ */ __name((hasSpace = false, prev = "", detectModulo = false) => {
      const ch = scnr.currentPeek();
      if (ch === "{") {
...
const generate = /* @__PURE__ */ __name((ast, options = {}) => {
...
__name(isMessageAST, "isMessageAST");
...
__name(resolveCases, "resolveCases");
const PROPS_STATIC = ["s", "static"];
function resolveStatic(node) {
  return resolveProps(node, PROPS_STATIC);
}
__name(resolveStatic, "resolveStatic");
const PROPS_ITEMS = ["i", "items"];
function resolveItems(node) {
  return resolveProps(node, PROPS_ITEMS, []);
}
__name(resolveItems, "resolveItems");
...
__name(resolveValue$1, "resolveValue$1");
const PROPS_MODIFIER = ["m", "modifier"];
function resolveLinkedModifier(node) {
  return resolveProps(node, PROPS_MODIFIER);
}
__name(resolveLinkedModifier, "resolveLinkedModifier");
...
__name(resolveLinkedKey, "resolveLinkedKey");
...
__name(createUnhandleNodeError, "createUnhandleNodeError");
...
function createMessageContext(options = {}) {
  ...
  const plural = /* @__PURE__ */ __name((messages) => {
    return messages[pluralRule(pluralIndex, messages.length, orgPluralRule)];
  }, "plural");
  const _list = options.list || [];
  const list = /* @__PURE__ */ __name((index) => _list[index], "list");
  ...
  const _modifier = /* @__PURE__ */ __name((name) => options.modifiers ? options.modifiers[name] : DEFAULT_MODIFIER, "_modifier");
...
const createResources = /* @__PURE__ */ __name((locale) => ({ [locale]: create() }), "createResources");
...
const defaultOnCacheKey = /* @__PURE__ */ __name((message) => message, "defaultOnCacheKey");
...
const compileToFunction = /* @__PURE__ */ __name(/* @__NO_SIDE_EFFECTS__ */ (message, context) => {
...
${codeFrame}` : message);
    ...
    onCacheKey: /* @__PURE__ */ __name((source2) => generateFormatCacheKey(locale, key, source2), "onCacheKey")
  };
}
...
function vTDirective(i18n) {
  ...
  const register = /* @__PURE__ */ __name((el, binding) => {
  ...
  const update = /* @__PURE__ */ __name((el, { value }) => {
    if (el.__composer) {
...
const castToVueI18n = /* @__PURE__ */ __name(/* @__NO_SIDE_EFFECTS__ */ (i18n) => {
...
//# sourceMappingURL=vendor-vue-i18n-CepkKHgT.js.map
